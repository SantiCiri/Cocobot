...
app = TradingHelper(log_name=f"operar_MR36O_LECHO")
        ...
        for position in [0, 1]:
            for term in terms:
                ...
                if amount_in_portfolio > 0:
                    ...
                    maximum_vol=100
                    if ratio >= 1.005: maximum_vol = 200
                    ...
                    if precio_venta_numerador == 0 or precio_compra_denominador == 0 or minimum_vol == 0:
                        break
                    if tickers[0]=="MR36O": min_ratio=1.004
                    elif tickers[0]=="LECHO": min_ratio = 1
                    ...
                    if ratio > min_ratio:
                        ...
                        if order_status == "EXECUTED" or order_status == "PARTIALLY_EXECUTED":
                            ...
                            buy_order = app.place_buy_order(mail=mail,
                                                            ...
                                                            term=term,
                                                            currency="pesos")
                            precio_compra_denominador_original=precio_compra_denominador
                            ...
                            while order_status == "MARKET" or order_status=="PENDING_OMS" or order_status=="REJECTED":
                                if order_status == "PENDING_OMS":
                                    ...
                                    try:
                                        ...
                                        if precio_compra_denominador > precio_compra_denominador_original+1:break
                                    except Exception as e:
